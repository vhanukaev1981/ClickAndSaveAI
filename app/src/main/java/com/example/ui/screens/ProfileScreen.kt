        ...
        item {
            Card(
                ...
                Column(
                    ...
                    Text(
                        "המערכת אינה מבצעת בעצמה מעבר ספק, תשלום או ביטול שירות. לפני העברת פרטים שאישרת לנותן שירות נבקש ממך אישור מפורש, ואיננו מעבירים את תוכן תיבת הדואר או את תמונת ההוצאות המלאה שלך.",
                        style = MaterialTheme.typography.bodyMedium
                    )
                }
            }
