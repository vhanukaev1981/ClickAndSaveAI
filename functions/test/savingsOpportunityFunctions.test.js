...
test("user-facing offer exposes first-year economics but never commission metadata", () => {
  ...
  assert.equal(result.firstYearCost, 1188);
...
test("user-facing opportunity preserves lifecycle and saving but strips internal commercial state", () => {
